...
public class ComLinkDriver
{
    ...
    //modbusЭ�鵥���Ĵ�����16bit��Ҳ����һ��short

    //д�����Ĵ��� ��һ�η���8���ֽ�
    //0x01 0x06 + 2���ֽڵ�ַ+���ֽ����ݣ�Ҳ����һ��short��+ 2���ֽڵ�crc
    ...
    //д����Ĵ��� ��һ�η��ͣ�9+����byte���ȣ����ֽ�
    //0x01 0x10 + 2���ֽڵ�ַ+���ֽڳ��ȣ�short���ݵĸ�����+ ���ֽ����ݳ��ȣ�byte������+ ���� + 2���ֽڵ�crc
    ...
    public void writeMultipleRegs(byte[] addr, byte[] data,int delay=0,int wait=0)
    {
        ...
        buff[4] = (byte)(data.Length / 2 / 256);// ��λ
        buff[5] = (byte)(data.Length / 2 % 256);// ��λ
    ...
    //�����������Ĵ�����һ�η���8���ֽ�
    //0x01 0x03 + 2���ֽڵ�ַ+���ֽڳ��ȣ�short���ݵĸ�����+ 2���ֽڵ�crc
    public void readReg(byte[] addr, ushort count,int delay=0, int wait=0)
    {
        ...
        buff[4] = (byte)(count/256);  // ��λ
        buff[5] = (byte)(count%256); ;  // ��λ
    ...
    private static List<byte> listDatBuffer = new List<byte>(); // �������ݻ���
